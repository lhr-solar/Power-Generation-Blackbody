 ...
 * @brief Blackbody A Temperature sensor test. Verify that:
 *      - Liveliness - verify that temperature measurements can be taken from each temperature sensor.
 *      - Replication - verify that temperature measurements can be taken at various operating frequencies and determine message dropout metrics.
 *      - Accuracy - verify that the sensors are accurate within a known range of temperature conditions, with the appropriate calibration function.
 * @version 0.1.0
 * @date 09-16-23
 *
 * @note Pinout:
